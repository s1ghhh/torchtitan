...
def init_model(job_config, train_spec, tokenizer, parallel_dims, pp_mesh, device, world_mesh, float8_handler, model_state_dict=None, optimizer_state_dict=None, drop_list=None):
    ...
    return model, optimizers, num_flop_per_token, pp_schedule, model_parts, has_first_stage, has_last_stage
...
def main(job_config: JobConfig):
    ...
    model, optimizers, num_flop_per_token, pp_schedule, model_parts, has_first_stage, has_last_stage = init_model(job_config, train_spec, tokenizer, parallel_dims, pp_mesh, device, world_mesh, float8_handler, model_state_dict=None, optimizer_state_dict=None, drop_list=None)
